  ...
  return (
    <div className='w-screen min-h-screen bg-white flex items-cetner justify-start flex-col @container relative'>
        <div className='w-screen @[420px]:h-[60px] @[200px]:h-[45px] bg-white flex flex-row items-center justify-between sticky top-0 z-30 backdrop-blur-sm opacity-80'>
          ...
          <div className='flex flex-row items-center justify-evenly @[320px]:w-[250px] @[280px]:w-[200px] @[200px]:w-[180px]'>
            ...
            <div className='w-[80px] flex items-center justify-center'>
              <Link to="/contact" className='cursor-pointer @[280px]:text-2xl @[200px]:mx-1 @[320px]:text-3xl @[200px]:text-xl @[320px]:mx-2'><span className='harabara'>Contact</span></Link>
            </div>
          </div>
        </div>
      <div>
